...
Flag :: enum u8 {
	...
	No_Optimization,
	// Reverse the pattern, the input string will still be iterated normally
	// Usually you would use this to find the last match by passing this flag and the reversed text to match against
	Reverse_Pattern,
}
